...
class CustomerResourceTest {
    ...
    @Test
    fun `sould create  a costume and return 201 status`(){
        //GIVEN
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(URL).contentType(MediaType.APPLICATION_JSON)
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("07400319450"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("eric@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua Nove"))
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("EricUpdate"))
    ...
    private fun buildCustomerDto(
        ...
        zipCode: String = "000000000",
        street: String = "Rua Nove"
